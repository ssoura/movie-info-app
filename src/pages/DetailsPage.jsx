...
<div className="w-full h-[400px] relative hidden lg:block">
  ...
  <div className="absolute inset-0 bg-gradient-to-b from-transparent via-neutral-900/90 to-neutral-900"></div>
</div>

          <div className='container mx-auto px-3 py-16 lg:py-0 flex flex-col lg:flex-row gap-5 lg:gap-10 relative lg:-mt-20'>
